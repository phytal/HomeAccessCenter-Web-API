    ...
    public class AttendanceForm
    {
        ...
        private void InitMonthKeys(HtmlDocument document)
        {
            ...
            if (calendarInfo != null)
            {
                ...
                Regex regex = new Regex(@"\('ctl00\$plnMain\$cldAttendance','([A-Za-z0-9\-]+)'\)$");
                ...
                if (match.Success)
                {
                    previousMonthKey = match.Groups[1].Value;
                }
                ...
                if (match.Success)
                {
                    nextMonthKey = match.Groups[1].Value;
                }
        ...
        public string GenerateFormBody(string monthKey)
        {
            ...
            foreach (var entry in _runChangeForm)
            {
