...
namespace HAC.API.Helpers {
    ...
    public sealed class LineReader : IEnumerable<string> {
        ...
        /// <param name="streamSource">Data source</param>
        /// <param name="encoding">
        ///     Encoding to use to decode the stream
        ///     into text
        /// </param>
        private LineReader(Func<Stream> streamSource, Encoding encoding)
        ...
        ///     into text
        /// </param>
        private LineReader(string filename, Encoding encoding)
